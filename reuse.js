    ...
    connectedCallback() {
      this.innerHTML = 
        ...
        <div class="col-lg-4 col-12 order-last order-md-last d-flex flex-column justify-content-center">
            <aside class="  w-85 m-3 p-3 my-header">
                <h3 class="display-6  fw-bold">VariSpace® Southlake is Move-In<br> Ready</h3>
                ...
                <button type="button" class="btn  site-btns mt-3 col-5 w-75">LEARN MORE ABOUT VARISPACE</button>
            </aside>
